...
if($dopost!='save')
{
    $row = $dsql->GetOne("select  * from #@__zpinfo where id='$aid'");
    ...
    $tags = GetTags($aid);
    include DedeInclude("templets/zpinfo_edit.htm");
    exit();
}
/*--------------------------------
function __save(){  }
...
//
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='zpinfo_add.php?cid=$typeid'><u>发布新信息</u></a>
    &nbsp;&nbsp;
    <a href='archives_do.php?aid=".$id."&dopost=editzpinfo'><u>查看更改</u></a>
    &nbsp;&nbsp;
    <a href='catalog_do.php?cid=$typeid&dopost=listzpinfo'><u>管理代表信息</u></a>
    &nbsp;&nbsp;
    $backurl
    ";
