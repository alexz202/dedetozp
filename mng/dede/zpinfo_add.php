...
//    }
    ...
    include DedeInclude("templets/zpinfo_add.htm");
    exit();
}
...
else if($dopost=='save')
{
    ...
    //保存到主表
     $query = "INSERT INTO `#@__zpinfo`(id,typeid,typeid2,sortrank,flag,ismake,channel,arcrank,click,money,title,shorttitle,
    color,writer,source,litpic,pubdate,senddate,mid,voteid,notpost,description,keywords,filename,dutyadmin,weight,belong)
    VALUES ('$arcID','$typeid','$typeid2','$sortrank','$flag','$ismake','$channelid','$arcrank','$click','$money',
    '$title','$shorttitle','$color','$writer','$source','$litpic','$pubdate','$senddate',
    '$adminid','$voteid','$notpost','$description','$keywords','$filename','$adminid','$weight',$belong);";
    ...
    if(empty($addtable))
    {
        $dsql->ExecuteNoneQuery("DELETE FROM `#@__zpinfo` WHERE id='$arcID'");
        $dsql->ExecuteNoneQuery("DELETE FROM `#@__arctiny` WHERE id='$arcID'");
...
//    ClearMyAddon($arcID, $title);
    ...
    //返回成功信息
    $msg = "    　　请选择你的后续操作：
    <a href='zpinfo_add.php?cid=$typeid'><u>继续发布</u></a>
    &nbsp;&nbsp;
    <a href='archives_do.php?aid=".$arcID."&dopost=editArchives'><u>更改</u></a>
    &nbsp;&nbsp;
    <a href='catalog_do.php?cid=$typeid&dopost=listzpinfo'><u>已发布管理</u></a>
    &nbsp;&nbsp;
    $backurl
  ";
