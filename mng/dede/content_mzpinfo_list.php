...
arc.channel,arc.arcrank,arc.click,arc.title,arc.color,arc.litpic,arc.pubdate,arc.mid,bm.name as bname,bm.type as btype
FROM `$maintable` arc left join `#@__member_belong` as bm on arc.belong=bm.id
$whereSql
ORDER BY $orderbyField DESC ,arc.belong asc";
