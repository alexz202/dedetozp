...
if($dopost!='save')
{
    ...
    $tags = GetTags($aid);
    include DedeInclude("templets/gas_edit.htm");
    exit();
}
/*--------------------------------
function __save(){  }
...
else if($dopost=='save')
{
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='gas_add.php?cid=$typeid'><u>发布新文章</u></a>
    &nbsp;&nbsp;
    <a href='gas_do.php?aid=".$id."&dopost=editArchives'><u>查看更改</u></a>
    &nbsp;&nbsp;
    <a href='$artUrl' target='_blank'><u>查看文章</u></a>
    &nbsp;&nbsp;
    <a href='catalog_do.php?cid=$typeid&dopost=listGas'><u>内容管理</u></a>
    &nbsp;&nbsp;
    $backurl
    ";
