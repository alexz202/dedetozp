...
define('SHEHUILVDI_I',57);//57
define('ZECEJIEDU_I',58);//57
...
define('SHEHUILVDI','shehuilvdi');//53
...
return array(
    ...
    'SERVICE'=>array(
        ...
        array('value'=>'森林资源','id'=>FORESTINFO_I,'nav'=>1),
		...
		array('value'=>'社会绿地','id'=>SHEHUILVDI_I,'nav'=>1),
		array('value'=>'政策解读','id'=>ZECEJIEDU_I,'nav'=>1),
    ),
	'HUDONG'=>array(
